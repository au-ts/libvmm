                            ...
                            size_t initrd_size)
{
    ...
    LOG_VMM("Copying guest DTB to GPA 0x%x (0x%x bytes)\n", dtb_dest_gpa, dtb_size);
    ...
    LOG_VMM("Copying guest initial RAM disk to GPA 0x%x (0x%x bytes)\n", initrd_dest_vmm, initrd_size);
