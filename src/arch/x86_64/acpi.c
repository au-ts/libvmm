...
#include "../../../examples/simple/board/x86_64_generic_vtx/simple_dsdt.hex"
...
uint64_t acpi_rsdp_init(uintptr_t guest_ram_vaddr, uint64_t ram_top, uint64_t *acpi_start_gpa, uint64_t *acpi_end_gpa)
{
    ...
    // @billn sus: simple_dsdt_aml_code, which comes from a C header generated by the ASL compiler,
