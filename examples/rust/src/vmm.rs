...
extern "C" {
    fn linux_setup_images(ram_start_gpa: usize,
                          kernel: usize, kernel_size: usize,
                          dtb_src: usize, dtb_dest_gpa: usize, dtb_size: usize,
                          initrd_src: usize, initrd_dest_gpa: usize, initrd_size: usize) -> usize;
