...
def parse_iozone_results(input_files, output_file):
    ...
    with open(output_file, 'w') as file:
        file.write("reclen,write_num1,write_num2,write_num3,write_avg,write_std,read_num1,read_num2,read_num3,read_Avg,read_std\n")
        for reclen, data in sorted(aggregated_results.items(), key=lambda x: int(x[0])):
            ...
            line = f"{reclen},{write_values_str},{write_avg},{write_std},{read_values_str},{read_avg},{read_std}\n"
            file.write(line)
