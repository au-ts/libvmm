...
ssh -X -C billn@dwarrowdelf.keg.cse.unsw.edu.au "qemu-system-x86_64 -accel kvm -cpu host,+fsgsbase,+pdpe1gb,+xsaveopt,+xsave,+vmx,+vme -kernel /opt/billn/scratch/sel4_32.elf -initrd /opt/billn/scratch/loader.img \
                        -serial mon:stdio \
                        -m size=2G \
                        -d guest_errors \
                        -cdrom /opt/billn/latest-nixos-minimal-x86_64-linux.iso \
