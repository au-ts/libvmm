...
#define GUEST_RAM_SIZE 0x16000000
#define GUEST_DTB_VADDR 0x55000000
#define GUEST_INIT_RAM_DISK_VADDR 0x53000000
...
uintptr_t gpu_rx_avail;
uintptr_t gpu_rx_used;
uintptr_t gpu_tx_avail;
uintptr_t gpu_tx_used;
uintptr_t gpu_rx_shared_dma_vaddr;
uintptr_t gpu_tx_shared_dma_vaddr;
...
void init(void) {
    ...
    // Register virtio_gpu device
    virtio_gpu_mmio_init(gpu_tx_avail, gpu_tx_used, gpu_tx_shared_dma_vaddr, gpu_rx_avail, gpu_rx_used, gpu_rx_shared_dma_vaddr);
    virq_register(GUEST_VCPU_ID, VIRTIO_GPU_IRQ, &virtio_gpu_mmio_ack, NULL);
