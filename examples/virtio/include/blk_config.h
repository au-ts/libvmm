...
#define BLK_CONFIG_REGION_SIZE              0x1000
#define BLK_CONFIG_REGION_SIZE_CLI0         BLK_CONFIG_REGION_SIZE
#define BLK_CONFIG_REGION_SIZE_CLI1         BLK_CONFIG_REGION_SIZE
