...
#define NET_MAX_CLIENT_QUEUE_CAPACITY                NET_RX_QUEUE_CAPACITY_CLI0
...
#define NET_MAX_QUEUE_CAPACITY MAX(NET_TX_QUEUE_CAPACITY_DRIV, MAX(NET_RX_QUEUE_CAPACITY_DRIV, NET_RX_QUEUE_CAPACITY_CLI0))
