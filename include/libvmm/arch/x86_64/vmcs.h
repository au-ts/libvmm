...
#if APIC_VIRT_LEVEL < APIC_VIRT_LEVEL_APICV
#define VMCS_SPC_DEFAULT (VMCS_SPC_ENABLE_EPT | VMCS_SPC_ENABLE_VPID | VMCS_SPC_ENABLE_XSAVES)
#else
...
#define VMCS_VEC_ENABLE_IA32E   BIT(9)
#define VMCS_VEC_LOAD_IA32_PAT  BIT(14)
#define VMCS_VEC_LOAD_IA32_EFER BIT(15)

/* Long mode default */
#define VMCS_VEC_LM_DEFAULT (VMCS_VEC_ENABLE_IA32E | VMCS_VEC_LOAD_IA32_EFER)