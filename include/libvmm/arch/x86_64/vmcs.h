...
#define VMCS_PPC_CR8_EXITING (BIT(19) | BIT(20))
#define VMCS_PPC_IRQ_WINDOW_EXITING BIT_LOW(2)

#define VMCS_PCC_DEFAULT (VMCS_PPC_ACTIVATE_SECONDARY_CTRL | VMCS_PPC_CR8_EXITING)
