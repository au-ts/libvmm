...
#define PAT_RESET_VALUE 0x0007040600070406ull

/* Some of the required bits are set by the kernel so we don't have to worry about them. */

/* [2] "Primary Processor-Based VM-Execution Controls Register" */
#define VMCS_PPVC_IRQ_WINDOW_EXIT          BIT(2)
#define VMCS_PPVC_CR8_LOAD_EXIT            BIT(19)
#define VMCS_PPVC_CR8_SAVE_EXIT            BIT(20)
#define VMCS_PPVC_USE_TPR_SHADOW           BIT(21)
#define VMCS_PPVC_ACTIVATE_SECONDARY_CTRL  BIT(31)

#if APIC_VIRT_LEVEL < APIC_VIRT_LEVEL_APICV
#define VMCS_PPVC_DEFAULT (VMCS_PPVC_ACTIVATE_SECONDARY_CTRL | VMCS_PPVC_CR8_LOAD_EXIT | VMCS_PPVC_CR8_SAVE_EXIT)
#define VMCS_PPVC_WAIT_IRQ_WINDOW (VMCS_PPVC_DEFAULT | VMCS_PPVC_IRQ_WINDOW_EXIT)
#else
#define VMCS_PPVC_DEFAULT (VMCS_PPVC_ACTIVATE_SECONDARY_CTRL | VMCS_PPVC_USE_TPR_SHADOW)
#endif
...
#if APIC_VIRT_LEVEL < APIC_VIRT_LEVEL_APICV
#define VMCS_SPC_DEFAULT (VMCS_SPC_ENABLE_VPID | VMCS_SPC_ENABLE_XSAVES)
#else
#define VMCS_SPC_DEFAULT (VMCS_SPC_ENABLE_VPID | VMCS_SPC_ENABLE_XSAVES | VMCS_SPC_ENABLE_VAPIC | VMCS_SPC_ENABLE_APIC_REG_VIRT | VMCS_SPC_ENABLE_VIRT_IRQ_DELIVERY)
#endif

/* [2] "Definitions of VM-Entry Controls" */
#define VMCS_VENC_ENABLE_IA32E   BIT(9)
#define VMCS_VENC_LOAD_IA32_PAT  BIT(14)
#define VMCS_VENC_LOAD_IA32_EFER BIT(15)
...
#define VMCS_VEXC_SAVE_EFER      BIT(20)
#define VMCS_VEXC_SAVE_VMX_TIMER BIT(22)

#define VMCS_VEXC_DEFAULT (VMCS_VEXC_SAVE_PAT | VMCS_VEXC_SAVE_EFER)
#define VMCS_VEXC_VMX_TIMER_ON (VMCS_VEXC_DEFAULT | VMCS_VEXC_SAVE_VMX_TIMER)